...
namespace LivePose.UI.Controls.Selectors;
...
public class ActionTimelineSelector(string id) : Selector<ActionTimelineSelectorEntry>(id)
{
    ...
    protected override void PopulateList()
    {
        foreach(var timeline in GameDataProvider.Instance.ActionTimelines.Values)
        {
            if(!string.IsNullOrEmpty(timeline.Key.ToString()))
                AddItem(new ActionTimelineSelectorEntry(timeline.Key.ToString(), (ushort)timeline.RowId, timeline.RowId, timeline.Key.ToString(), ActionTimelineSelectorEntry.OriginalType.Raw, ActionTimelineSelectorEntry.AnimationPurpose.Unknown, (ActionTimelineService.ActionTimelineSlots)timeline.Slot, 0));
        }
        foreach(var emote in GameDataProvider.Instance.Emotes.Values)
        {
            ...
            {
                AddItem(new ActionTimelineSelectorEntry(emote.Name.ToString(), (ushort)timeline.RowId, emote.RowId, timeline.Key.ToString(), ActionTimelineSelectorEntry.OriginalType.Emote, ActionTimelineSelectorEntry.AnimationPurpose.Standard, (ActionTimelineService.ActionTimelineSlots)timeline.Slot, emote.Icon));
            }
            ...
            {
                AddItem(new ActionTimelineSelectorEntry(emote.Name.ToString(), (ushort)timeline.RowId, emote.RowId, timeline.Key.ToString(), ActionTimelineSelectorEntry.OriginalType.Emote, ActionTimelineSelectorEntry.AnimationPurpose.Intro, (ActionTimelineService.ActionTimelineSlots)timeline.Slot, emote.Icon));
            }
            ...
            {
                AddItem(new ActionTimelineSelectorEntry(emote.Name.ToString(), (ushort)timeline.RowId, emote.RowId, timeline.Key.ToString(), ActionTimelineSelectorEntry.OriginalType.Emote, ActionTimelineSelectorEntry.AnimationPurpose.Ground, (ActionTimelineService.ActionTimelineSlots)timeline.Slot, emote.Icon));
            }
            ...
            {
                AddItem(new ActionTimelineSelectorEntry(emote.Name.ToString(), (ushort)timeline.RowId, emote.RowId, timeline.Key.ToString(), ActionTimelineSelectorEntry.OriginalType.Emote, ActionTimelineSelectorEntry.AnimationPurpose.Chair, (ActionTimelineService.ActionTimelineSlots)timeline.Slot, emote.Icon));
            }
            ...
            {
                AddItem(new ActionTimelineSelectorEntry(emote.Name.ToString(), (ushort)timeline.RowId, emote.RowId, timeline.Key.ToString(), ActionTimelineSelectorEntry.OriginalType.Emote, ActionTimelineSelectorEntry.AnimationPurpose.Blend, (ActionTimelineService.ActionTimelineSlots)timeline.Slot, emote.Icon));
            }
        }
    ...
    protected override int Compare(ActionTimelineSelectorEntry itemA, ActionTimelineSelectorEntry itemB)
    {
        ...
        // Base Actions first
        if(itemA.Slot == ActionTimelineService.ActionTimelineSlots.Base && itemB.Slot != ActionTimelineService.ActionTimelineSlots.Base)
            return -1;
    ...
    protected override bool Filter(ActionTimelineSelectorEntry item, string search)
    {
        ...
        if(item.Slot != ActionTimelineService.ActionTimelineSlots.Base && !_showBlendable)
            return false;
...
public record class ActionTimelineSelectorEntry(string Name, ushort TimelineId, uint SecondaryId, string Key, ActionTimelineSelectorEntry.OriginalType TimelineType, ActionTimelineSelectorEntry.AnimationPurpose Purpose, ActionTimelineService.ActionTimelineSlots Slot, uint Icon)
{
