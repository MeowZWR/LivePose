...
public class FestivalSelector(string id, IEnumerable<FestivalService.FestivalEntry> entries) : Selector<FestivalService.FestivalEntry>(id)
{
    ...
    private readonly IEnumerable<FestivalService.FestivalEntry> _entries = entries;
    ...
    protected override void DrawItem(FestivalService.FestivalEntry item, bool isHovered)
    {
    ...
    protected override bool Filter(FestivalService.FestivalEntry item, string search)
    {
