...
public class SettingsWindow : Window
{
    ...
    public SettingsWindow(ConfigurationService configurationService, EntityManager entityManager, IClientState clientState) : base($"{LivePose.Name} 设置###livepose_settings_window", ImGuiWindowFlags.None)
    {
