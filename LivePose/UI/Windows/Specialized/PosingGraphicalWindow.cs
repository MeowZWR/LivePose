...
public class PosingGraphicalWindow : Window, IDisposable
{
    ...
    public override bool DrawConditions()
    {
        ...
        if(!_entityManager.TryGetCapabilityFromSelectedEntity<PosingCapability>(out var posing) || !_entityManager.SelectedHasCapability<ActorAppearanceCapability>())
        {
            return false;
        }
