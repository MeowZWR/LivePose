...
public class PosingTransformWindow : Window
{
    ...
    public PosingTransformWindow(EntityManager entityManager, PosingService posingService, IClientState clientState, ICondition conditions) : base($"{LivePose.Name} - 变换###livepose_transform_window", ImGuiWindowFlags.AlwaysAutoResize)
    {
